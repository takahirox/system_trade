-- generate dji weekly basic data from dji daily
insert into dji_weekly(date, open, high, low, close)
...
-- generate dji weekly id
update dji_weekly t1
  inner join (
    select t.date date,
           @n:=@n+1 id
    from dji_weekly t,
...
-- generate dji weekly change
update dji_weekly t3
  inner join (
    select t1.date date,
...
-- generate dji_weekly candle and beard
update dji_weekly t1
  inner join (
    select date date,
           close-open candle,
